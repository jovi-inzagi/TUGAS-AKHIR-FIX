...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Frame fram, Type type, Location location, String message) {
        ...
        init(message);
        initAnimator();
        lbMessage.setFont(new java.awt.Font("SansSerif", java.awt.Font.BOLD, 18));
        lbMessage.setForeground(java.awt.Color.BLACK);  

        lbMessageText.setFont(new java.awt.Font("SansSerif", java.awt.Font.BOLD, 16));
        lbMessageText.setForeground(java.awt.Color.BLACK);
    }
    ...
    private void init(String message) {
        ...
        dialog.add(this);
        dialog.getContentPane().setPreferredSize(getPreferredSize());
        dialog.pack();
